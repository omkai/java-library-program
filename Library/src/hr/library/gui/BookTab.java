...
public class BookTab extends JPanel {
	...
	public BookTab() {
		...
		//adds the layout to the text fields and labels
		updateMainPanel.setBorder(border);
				...
				public void run() {
					try {
						if(Tname.getText().toString().length() == 0 ||
							...
							JOptionPane.showMessageDialog(BookTab.this, "All fields have to be filled");
						} else if(Database.getBook(Integer.parseInt(Tid.getText().toString())) != null) {
							JOptionPane.showMessageDialog(BookTab.this,  "Book already exists");
						} else if(Database.getBook(Integer.parseInt(Tid.getText().toString())) == null) {
							...
							addRow();
							JOptionPane.showMessageDialog(BookTab.this, "Book added");
						}
					} catch(Exception e) {
						e.printStackTrace();
						JOptionPane.showMessageDialog(BookTab.this, "Invalid input");
					}				
				}
			};
